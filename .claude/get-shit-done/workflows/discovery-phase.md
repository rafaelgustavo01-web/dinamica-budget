...
See /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/discovery.md
...
Use /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/discovery.md.
