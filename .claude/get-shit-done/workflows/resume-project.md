...
<required_reading>
@/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
