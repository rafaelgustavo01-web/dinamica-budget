...
- **Global scope**: `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/notes/`)
...
2. Glob `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/notes/` — works in any directory
