...
- Usage: Reference from command with `@/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
