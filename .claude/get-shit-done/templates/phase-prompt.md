...
<!-- For checkpoint task examples and patterns, see @/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/references/checkpoints.md -->
...
See `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
