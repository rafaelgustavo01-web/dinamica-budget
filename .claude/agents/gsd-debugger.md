...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude
                  → checks /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done
                  → writes to /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/hooks/
...
@/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
