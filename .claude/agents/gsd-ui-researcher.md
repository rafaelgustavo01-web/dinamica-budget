...
Use template from `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
