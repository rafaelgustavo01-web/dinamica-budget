...
<reference>
@/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/references/user-profiling.md` to load:
