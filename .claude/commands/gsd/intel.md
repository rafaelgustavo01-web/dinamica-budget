...
Intel system is disabled. To activate:
  ...
  node /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/bin/gsd-tools.cjs
