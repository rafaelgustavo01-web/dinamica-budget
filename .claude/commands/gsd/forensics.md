...
<execution_context>
@/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
