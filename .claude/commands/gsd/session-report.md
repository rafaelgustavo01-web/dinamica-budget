...
<execution_context>
@/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/sessions/peaceful-affectionate-bell/mnt/Dinamica Budget/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
