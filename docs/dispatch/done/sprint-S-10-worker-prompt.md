...
@docs/briefings/sprint-S-10-briefing.md

Execute the approved plan:
@docs/superpowers/plans/2026-04-23-importacao-pq-match-inteligente.md
...
- Generate or update `docs/technical-review-2026-04-23-s10.md`.
- Save the walkthrough to `docs/walkthrough/done/walkthrough-S-10.md`.
