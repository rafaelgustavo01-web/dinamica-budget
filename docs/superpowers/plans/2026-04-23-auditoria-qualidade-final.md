...
$testResult = & python -m pytest "$ProjectRoot/app/tests/unit" -q 2>&1
...
**Files:**
- Create: `app/tests/e2e/test_smoke_proposta.py`

### Step 1: Teste E2E básico

```python
# app/tests/e2e/test_smoke_proposta.py
import pytest
...
```bash
git add app/tests/e2e/test_smoke_proposta.py
...
Create: `docs/walkthrough/done/walkthrough-S-08.md`

### Step 1: Commit

```bash
git add docs/walkthrough/done/walkthrough-S-08.md
...
**Plan complete and saved to `docs/superpowers/plans/2026-04-23-auditoria-qualidade-final.md`.**
