...
**Files:**
- Create: `frontend/src/features/proposals/routes.tsx`
- Create: `frontend/src/features/proposals/types.ts`
- Modify: `frontend/src/App.tsx` ou router principal
...
```tsx
// frontend/src/features/proposals/routes.tsx
...
```bash
git add frontend/src/features/proposals/
...
**Files:**
- Create: `frontend/src/features/proposals/pages/ProposalsListPage.tsx`
- Create: `frontend/src/features/proposals/components/ProposalsTable.tsx`

### Step 1: Página de listagem

```tsx
// frontend/src/features/proposals/pages/ProposalsListPage.tsx
...
```tsx
// frontend/src/features/proposals/components/ProposalsTable.tsx
import { useNavigate } from "react-router-dom";
...
```bash
git add frontend/src/features/proposals/pages/ frontend/src/features/proposals/components/
...
**Files:**
- Create: `frontend/src/features/proposals/pages/ProposalCreatePage.tsx`
...
```tsx
// frontend/src/features/proposals/pages/ProposalCreatePage.tsx
import { useNavigate } from "react-router-dom";
...
```bash
git add frontend/src/features/proposals/pages/ProposalCreatePage.tsx frontend/src/features/proposals/components/ProposalForm.tsx
...
**Files:**
- Create: `frontend/src/features/proposals/pages/ProposalImportPage.tsx`

### Step 1: Página de importação

```tsx
// frontend/src/features/proposals/pages/ProposalImportPage.tsx
import { useState } from "react";
...
```bash
git add frontend/src/features/proposals/pages/ProposalImportPage.tsx
...
**Files:**
- Create: `frontend/src/features/proposals/pages/ProposalCpuPage.tsx`
- Create: `frontend/src/features/proposals/components/CpuTable.tsx`

### Step 1: Tabela de CPU

```tsx
// frontend/src/features/proposals/components/CpuTable.tsx
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
...
```tsx
// frontend/src/features/proposals/pages/ProposalCpuPage.tsx
import { useState } from "react";
...
```bash
git add frontend/src/features/proposals/pages/ProposalCpuPage.tsx frontend/src/features/proposals/components/CpuTable.tsx
...
**Files:**
- Modify: `frontend/src/App.tsx` (ou arquivo de rotas principal)
...
**Files:**
- Create: `docs/walkthrough/done/walkthrough-S-12.md`
...
```bash
git add docs/walkthrough/done/walkthrough-S-12.md
...
**Plan complete and saved to `docs/superpowers/plans/2026-04-23-ux-frontend-modulo-orcamentos.md`.**
