...
5. Iniciar backend: `uvicorn app.main:app --host 0.0.0.0 --port 8000`
...
Create: `docs/walkthrough/done/walkthrough-S-06.md`

### Step 3: Commit

```bash
git add docs/walkthrough/done/walkthrough-S-06.md
...
**Plan complete and saved to `docs/superpowers/plans/2026-04-23-runbook-observabilidade-onpremise.md`.**
