...
**Files:**
- Create: `frontend/src/pages/admin/users/UserListPage.tsx`
- Create: `frontend/src/pages/admin/users/UserListTable.tsx`
...
```tsx
// frontend/src/pages/admin/users/UserListTable.tsx
...
```tsx
// frontend/src/routes.tsx (adicionar dentro do layout admin)
...
**Files:**
- Create: `frontend/src/pages/admin/clients/ClientPerfisPage.tsx`
- Create: `frontend/src/pages/admin/clients/ClientePerfilForm.tsx`

### Step 1: Criar página de perfis

```tsx
// frontend/src/pages/admin/clients/ClientPerfisPage.tsx
...
```tsx
// frontend/src/pages/admin/clients/ClientePerfilForm.tsx
...
```bash
git add frontend/src/pages/admin/clients/
...
**Files:**
- Create: `frontend/src/pages/profile/MeuPerfilPage.tsx`

### Step 1: Criar página de perfil

```tsx
// frontend/src/pages/profile/MeuPerfilPage.tsx
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { api } from "@/lib/api";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
...
```bash
git add frontend/src/pages/profile/MeuPerfilPage.tsx
...
Create: `docs/walkthrough/done/walkthrough-S-07.md`

### Step 3: Commit

```bash
git add docs/walkthrough/done/walkthrough-S-07.md
...
**Plan complete and saved to `docs/superpowers/plans/2026-04-23-ux-governanca-permissoes.md`.**
