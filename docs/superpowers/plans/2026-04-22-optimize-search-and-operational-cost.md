...
| `alembic/versions/xxx_add_search_indexes.py` | Create | Alembic migration adding GIN (pg_trgm) and HNSW (pgvector) indexes safely |
| `docs/technical-review-2026-04-22.md` | Update | Report with benchmark results and final recommendation |
| `docs/walkthrough/done/walkthrough-S-05.md` | Create | Evidence of execution and decisions |
...
**Files:**
- Create: `alembic/versions/xxx_add_search_indexes.py`
...
Note the generated filename (e.g., `alembic/versions/2026_04_22_add_search_indexes.py`).

- [ ] **Step 2: Implement the migration**

```python
# alembic/versions/2026_04_22_add_search_indexes.py
"""add_search_indexes
...
```bash
git add alembic/versions/2026_04_22_add_search_indexes.py
...
**Files:**
- Create/Update: `docs/technical-review-2026-04-22.md`
...
Migration: `alembic/versions/2026_04_22_add_search_indexes.py`
...
```bash
git add docs/technical-review-2026-04-22.md
...
**Files:**
- Create: `docs/walkthrough/done/walkthrough-S-05.md`
...
2. **Indexes Created**
   - Alembic migration `alembic/versions/2026_04_22_add_search_indexes.py`
...
4. **Technical Review Written**
   - `docs/technical-review-2026-04-22.md` contains evidence and recommendations
...
- `scripts/test_model_ptbr.py`
- `alembic/versions/2026_04_22_add_search_indexes.py`
- `docs/technical-review-2026-04-22.md`
...
```bash
git add docs/walkthrough/done/walkthrough-S-05.md
...
- File paths match existing repo structure (`scripts/`, `alembic/versions/`, `docs/`).
