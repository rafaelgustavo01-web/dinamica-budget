...
> Plan: `docs/superpowers/plans/2026-04-22-align-authorization-onpremise-model.md`
...
- `app/tests/unit/test_security_p0.py`: add 5 new tests, remove 2 obsolete tests
- `app/tests/integration/test_auth_access_control.py`: append 1 integration test
- Validation commands:
```bash
pytest app/tests/unit/test_security_p0.py -v
pytest app/tests/integration/test_auth_access_control.py -v
pytest app/tests/unit/test_busca_service.py -v
```

## Required Artifacts Before Status `TESTED`

- `docs/technical-review-2026-04-22.md` updated
- `docs/walkthrough/done/walkthrough-S-01.md` written
