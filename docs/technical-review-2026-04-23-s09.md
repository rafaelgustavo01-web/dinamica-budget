...
- `python -m compileall app/api/v1/endpoints/propostas.py app/services/proposta_service.py alembic/versions/017_create_proposta_entities.py app/models/proposta.py app/schemas/proposta.py`
