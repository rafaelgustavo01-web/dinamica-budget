...
- `pytest app/backend/tests/integration/test_auth_access_control.py -q` failed during fixture setup because local `dinamica_budget_test` connection closed mid-operation via `asyncpg.exceptions.ConnectionDoesNotExistError`.
