...
- Test: `app/backend/tests/unit/test_transactional_purity.py`
...
- Test: `app/backend/tests/integration/test_transaction_rollback.py`
...
**Files:**
- Test: full unit suite (pytest app/backend/tests/unit)
- Create: `docs/sprints/S-03/walkthrough/done/walkthrough-S-03.md`
...
**Plan complete and saved to `docs/sprints/S-09/plans/2026-04-23-revisao-transacional.md`.**
