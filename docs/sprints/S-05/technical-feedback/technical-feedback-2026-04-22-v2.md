...
| Walkthrough existe em `docs/sprints/S-05/walkthrough/done/walkthrough-S-05.md` | ✅ |
| Technical review existe em `docs/sprints/S-05/technical-review/technical-review-2026-04-22.md` | ✅ |
...
| 5.4 Safe database indexes | `app/alembic/versions/016_add_search_indexes.py` | ✅ | ✅ (upgrade head = 016) | 3 índices criados |
| 5.5 Document findings | `docs/sprints/S-05/technical-review/technical-review-2026-04-22.md` | ✅ | — | Números reais referenciados |
| 5.6 Write walkthrough | `docs/sprints/S-05/walkthrough/done/walkthrough-S-05.md` | ✅ | — | Completo |
...
| `docs/sprints/S-05/technical-review/technical-review-2026-04-22.md` com números reais | ✅ |
| `docs/sprints/S-05/walkthrough/done/walkthrough-S-05.md` escrito | ✅ |
