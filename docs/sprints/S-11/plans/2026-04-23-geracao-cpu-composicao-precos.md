...
**Files:**
- Create: `app/backend/tests/unit/test_cpu_geracao_service.py`

### Step 1: Testar orquestração

```python
# app/backend/tests/unit/test_cpu_geracao_service.py
import uuid
import pytest
from decimal import Decimal
...
```bash
git add app/backend/tests/unit/test_cpu_geracao_service.py
...
Create: `docs/sprints/S-11/walkthrough/done/walkthrough-S-11.md`

### Step 3: Commit

```bash
git add docs/sprints/S-11/walkthrough/done/walkthrough-S-11.md
...
**Plan complete and saved to `docs/sprints/S-10/plans/2026-04-23-geracao-cpu-composicao-precos.md`.**
