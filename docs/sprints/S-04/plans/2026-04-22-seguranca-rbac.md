...
- Test: `app/backend/tests/unit/test_security_s04.py`
...
**Files:**
- Create: `app/backend/tests/unit/test_security_s04.py`

### Step 1: Testar cenários de acesso negado

```python
# app/backend/tests/unit/test_security_s04.py
import uuid
import pytest
...
```bash
git add app/backend/tests/unit/test_security_s04.py
...
**Files:**
- Create: `docs/sprints/S-04/walkthrough/done/walkthrough-S-04.md`
...
```bash
git add docs/sprints/S-04/walkthrough/done/walkthrough-S-04.md docs/technical-review-2026-04-22-s04.md
...
**Plan complete and saved to `docs/sprints/S-03/plans/2026-04-22-seguranca-rbac.md`.**
