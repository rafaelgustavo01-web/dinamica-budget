...
**Files:**
- Create: `app/backend/tests/unit/test_pq_import_service.py`
- Create: `app/backend/tests/unit/test_pq_match_service.py`

### Step 1: Testar importação

```python
# app/backend/tests/unit/test_pq_import_service.py
import uuid
import pytest
...
```bash
git add app/backend/tests/unit/test_pq_import_service.py app/backend/tests/unit/test_pq_match_service.py
...
```bash
git add app/alembic/versions/xxxx_add_pq_importacao_and_pq_item.py
...
Create: `docs/sprints/S-10/walkthrough/done/walkthrough-S-10.md`

### Step 3: Commit

```bash
git add docs/sprints/S-10/walkthrough/done/walkthrough-S-10.md
...
**Plan complete and saved to `docs/sprints/S-06/plans/2026-04-23-importacao-pq-match-inteligente.md`.**
