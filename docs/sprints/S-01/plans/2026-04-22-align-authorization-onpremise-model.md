...
| `app/backend/tests/unit/test_security_p0.py` | Modify | Replace cross-tenant isolation tests with open-read policy tests |
| `app/backend/tests/integration/test_auth_access_control.py` | Modify | Adjust assertions to match open-read behavior |
...
- Test: `app/backend/tests/unit/test_security_p0.py`
...
Run: `pytest app/backend/tests/unit/test_security_p0.py::test_get_servico_propria_open_to_any_authenticated_user -v`
...
```bash
git add app/api/v1/endpoints/servicos.py app/backend/tests/unit/test_security_p0.py
...
Run: `pytest app/backend/tests/unit/test_security_p0.py::test_list_servicos_with_cliente_id_no_access_check -v`
...
Run: `pytest app/backend/tests/unit/test_security_p0.py::test_list_versoes_open_to_any_authenticated_user -v`
...
```bash
git add app/api/v1/endpoints/versoes.py app/backend/tests/unit/test_security_p0.py
...
Run: `pytest app/backend/tests/unit/test_security_p0.py::test_buscar_servicos_no_cliente_access_required app/backend/tests/unit/test_security_p0.py::test_list_associacoes_no_cliente_access_required -v`
...
```bash
git add app/api/v1/endpoints/busca.py app/backend/tests/unit/test_security_p0.py
...
**Files:**
- Modify: `app/backend/tests/unit/test_security_p0.py`
...
The following tests in `app/backend/tests/unit/test_security_p0.py` are now invalid:
- `test_get_servico_propria_blocks_wrong_tenant`
- `test_get_servico_propria_allows_correct_tenant`

- [ ] **Step 2: Remove obsolete tests**

Delete lines 113-168 and 170-219 from `app/backend/tests/unit/test_security_p0.py` (the two tenant-blocking tests).

- [ ] **Step 3: Run remaining tests**

Run: `pytest app/backend/tests/unit/test_security_p0.py -v`
...
```bash
git add app/backend/tests/unit/test_security_p0.py
...
**Files:**
- Modify: `app/backend/tests/integration/test_auth_access_control.py`
...
Run: `pytest app/backend/tests/integration/test_auth_access_control.py -v`
...
```bash
git add app/backend/tests/integration/test_auth_access_control.py
...
Run: `pytest app/backend/tests/unit/test_security_p0.py::test_write_endpoints_still_require_client_perfil -v`
...
Run: `pytest app/backend/tests/unit/test_security_p0.py app/backend/tests/integration/test_auth_access_control.py -v`
