...
- `feat(f2-03): add PqItemResponse and PqMatchConfirmarRequest schemas`
- `feat(f2-03): add GET /pq/itens and PATCH /pq/itens/{id}/match endpoints`
- `feat(f2-03): add PqItem types and listPqItens/confirmarMatch to proposalsApi`
- `feat(f2-03): add ServicoPickerDialog component`
- `feat(f2-03): add MatchItemRow component with confirm/reject/substitute actions`
- `feat(f2-03): add MatchReviewPage with progress bar and item table`
- `feat(f2-03): wire match-review navigation into ImportPage and DetailPage`
