...
> **Plano Técnico:** `docs/sprints/S-02/plans/2026-04-22-arquitetura-camadas.md` (v2 revisado)  
...
- [ ] `pytest app/backend/tests/unit/test_auth_service.py` — **ALL PASS**
- [ ] `pytest app/backend/tests/unit/test_versao_service.py` — **ALL PASS**
- [ ] `pytest app/backend/tests/integration/test_auth_access_control.py` — **ALL PASS** (regressão)
- [ ] `pytest app/backend/tests/` — **ALL PASS** (suite completa)
