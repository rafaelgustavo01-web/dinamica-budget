...
- Added `app/tests/unit/test_transactional_purity.py`.
...
- Integration regression was attempted with `pytest app/tests/integration/test_auth_access_control.py -q`, but local PostgreSQL test DB connectivity failed during fixture setup before assertions ran.
