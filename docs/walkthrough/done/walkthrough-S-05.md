...
- `alembic/versions/012_base_consulta_pc_orcamento.py`: trilha de PC/Orçamento ajustada para coexistir com o dual-schema.
- `alembic/versions/013_expand_pc_numeric_ranges.py`: `down_revision` alinhado à nova sequência linear.
