...
| `F2-DT-C` | TESTED | P2 | `F2-DT-A`, `F2-DT-B` | **Frontend Smoke Tests (Solo, HOLD)** — 4 arquivos de teste smoke em **/__tests__/** para Histograma (3 abas), ExpandableTreeRow, ProposalsListPage, ProposalDetailPage | 1 commit `test(f2-dt-c)`; 12+ asserts; npm run test passa; npm run build verde; apenas arquivos novos (sem modificar producao); branch main apenas |
...
- `F2-DT-A` TESTED — Backend Tech Debt Cleanup — Worker: claude-sonnet-4-6 — 223 PASS, 0 errors; walkthrough em `docs/sprints/F2-DT-A/walkthrough/done/walkthrough-F2-DT-A.md`; technical-review em `docs/sprints/F2-DT-A/technical-review/technical-review-2026-04-28-f2-dt-a.md`
