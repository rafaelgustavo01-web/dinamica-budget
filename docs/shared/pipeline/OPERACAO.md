...
**Worker**
```
Você é o Worker de execução deste projeto. Leia sua introdução em docs/roles/worker-readme.md e processe apenas as mensagens [PENDING]. Sprint: S-04. Action: BUILD. Briefing: @docs/sprints/S-04/briefing/sprint-S-04-briefing.md. Plan: @docs/sprints/S-03/plans/2026-04-22-seguranca-rbac.md. Siga o protocolo da role, execute apenas o escopo aprovado e atualize inbox/artefatos ao concluir.
```

**QA**
```
Você é o QA deste projeto. Leia sua introdução em docs/roles/qa-readme.md e processe apenas as mensagens [PENDING]. Sprint: S-02. Action: REVIEW. Briefing: @docs/sprints/S-02/briefing/sprint-S-02-briefing.md. Siga o protocolo da role, execute apenas o escopo aprovado e atualize inbox/artefatos ao concluir.
```
