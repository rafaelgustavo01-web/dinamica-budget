...
| `S-03` | TODO | P1 | `S-02` | Revisar fronteira transacional para reduzir commit implícito global | Estratégia transacional documentada e aplicada; operações de leitura sem efeitos colaterais; regressão de autenticação/busca/homologação validada |
...
2. `S-02`
3. `S-03`
4. `S-04` (em paralelo com S-03 se equipe permitir, mas S-03 tem prioridade de fluxo agora)
5. `S-05` e `S-06`
6. `S-07`
7. `S-08`
8. `S-09` (depende de S-02 e S-05)
9. `S-10` → `S-11` → `S-12` (sequencial)

## Sprints Ativas (Product Owner — 2026-04-23)
- `S-01` DONE; `S-05` DONE; `S-02` DONE; `S-03` em `TODO`; `S-04` em `PLAN`. WIP atual = 2/2.
- Justificativa: S-02 concluída. S-03 avançou para execução (TODO). S-04 aguarda liberação de slot.
