...
if "!HAS_NSSM!"=="0" (
    ...
    call :pend "  nssm install !SVC! \"!APP!\venv\Scripts\python.exe\" \"-m uvicorn backend.main:app --host 127.0.0.1 --port !API_PORT! --workers 2\""
...
if errorlevel 1 (
    ...
    "!NSSM_CMD!" install "!SVC!" "!APP!\venv\Scripts\python.exe" "-m uvicorn backend.main:app --host 127.0.0.1 --port !API_PORT! --workers 2" >> "!LOG!" 2>&1
    if errorlevel 1 (
    ...
    "!NSSM_CMD!" set "!SVC!" AppParameters "-m uvicorn backend.main:app --host 127.0.0.1 --port !API_PORT! --workers 2" >> "!LOG!" 2>&1
)
