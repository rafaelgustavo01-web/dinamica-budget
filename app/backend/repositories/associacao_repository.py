...
from backend.models.associacao_inteligente import AssociacaoInteligente, CONSOLIDACAO_THRESHOLD
from backend.models.enums import OrigemAssociacao, StatusValidacaoAssociacao
