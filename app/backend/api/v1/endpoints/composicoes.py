...
from backend.core.dependencies import get_current_active_user, get_db, require_cliente_perfil
...
from backend.schemas.composicao import AdicionarComponenteRequest, ClonarComposicaoRequest
